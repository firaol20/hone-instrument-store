          ...
          <div className="flex items-center gap-12">
            <Link href="/" className="flex items-center gap-3 group">
              <div className="relative flex h-11 w-11 items-center justify-center rounded-2xl bg-slate-950 shadow-2xl group-hover:scale-105 transition-transform border border-white/10 overflow-hidden">
                <Image src="https://res.cloudinary.com/dglvpzqcl/image/upload/v1778093864/hone_store/website.jpg" alt="Hone Musical Instruments Logo" fill className="object-cover brightness-110" unoptimized />
              </div>
